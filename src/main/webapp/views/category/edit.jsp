...
<div class="container">
    <div class="row">
        <div class="col-lg-6">
            <form:form action="${pageContext.request.contextPath}/category-update" method="post"
                       modelAttribute="category">
                <form:input type="text" path="categoryId"/>
                <div class="form-group">
                    <label>Category Name</label>
                    <form:input type="text" path="categoryName" class="form-control" placeholder="Enter name"/>
