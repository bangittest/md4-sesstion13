...
<body>
<form:form method="post" action="/update-product" modelAttribute="product">
    <label>Ten san pham</label>
    <form:input type="text"
                class="form-control" aria-describedby="helpId" placeholder="nhap ten san pham" path="productId"/>
    <form:input type="text"
